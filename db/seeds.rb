...
rv1 = Rv.create(name: "Sprinter", image_url: "https://tinyurl.com/yckjdn4a", description: "A well-maintained high-performance vehicle.  Features a kitchenette, bathroom, shower, sleeps 4 adults.  Well worth the expense!", region: "HTX", mileage: Faker::Number.within(range: 21000..140000))
...
rv3 = Rv.create(name: "Palace on Wheels", image_url: "https://tinyurl.com/yu57d5p9", description: "Get your checkbook ready.  She's a beaut!  Features a kitchenette, bathroom, shower, dining/living area, jacuzzi, 4-wheeler, satelite tv, sleeps 10 adults.", region: "DFW", mileage: Faker::Number.within(range: 21000..140000))
